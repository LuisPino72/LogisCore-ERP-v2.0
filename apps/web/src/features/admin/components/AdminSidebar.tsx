...
const modules: { id: AdminModule; label: string; icon: string }[] = [
  ...
  { id: "tenants", label: "Tenants", icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h-2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-1 4h1m2-4h.01M9 21h1m-1 4h1m4-4h.01M9 17h.01" },
