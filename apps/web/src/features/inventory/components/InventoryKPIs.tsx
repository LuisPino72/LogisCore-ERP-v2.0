...
export function InventoryKPIs({ totalValue, lowStockCount, lastCount }: InventoryKPIsProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
      <Tooltip content="Valor total del inventario en Bolivares (Bs)" position="top">
      ...
      <Tooltip content="Productos con stock por debajo del mínimo configurado" position="top">
        <div className="card p-4 flex items-center gap-4 cursor-help hover:bg-surface-50 transition-colors">
      ...
      <Tooltip content="Fecha del último conteo de inventario realizado" position="top">
        <div className="card p-4 flex items-center gap-4 cursor-help hover:bg-surface-50 transition-colors">
