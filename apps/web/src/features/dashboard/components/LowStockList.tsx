    ...
    <div className="space-y-2">
      {products.map((product) => (
        <Tooltip 
          ...
          position="right"
        >
          <div className="flex items-center justify-between p-2 rounded-lg bg-state-error/5 border border-state-error/10 cursor-help">
            <div className="flex items-center gap-2 min-w-0">
              <svg className="w-4 h-4 text-state-error shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              <span className="text-sm font-bold text-state-error">
