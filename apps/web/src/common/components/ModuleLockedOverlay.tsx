...
export function ModuleLockedOverlay({
  ...
  return (
    <div className="relative w-full h-full min-h-[400px]">
      <div className="absolute inset-0 bg-linear-to-br from-surface-50 via-white to-surface-100" />
      ...
      <div className="relative z-10 flex items-center justify-center h-full">
        <div className="bg-white/90 backdrop-blur-md border border-surface-200 rounded-2xl shadow-2xl p-8 max-w-md text-center">
          <div className="flex justify-center mb-4">
            <div className="w-16 h-16 bg-linear-to-br from-amber-400 to-amber-600 rounded-full flex items-center justify-center shadow-lg">
          ...
          {onUpgrade && (
            <button
              onClick={onUpgrade}
              className="btn btn-primary w-full bg-linear-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 border-amber-500"
            >
