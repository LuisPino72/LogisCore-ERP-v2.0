...
export const Sidebar = memo(function Sidebar({ items, activeItem, onItemClick, collapsed = false, onToggleCollapse }: SidebarProps) {
  return (
    <aside
    ...
    >
      ...
      {onToggleCollapse && (
        <button
          ...
          className="p-3 border-t border-surface-200 text-content-secondary hover:text-content-primary transition-colors"
        >
